...
namespace StackUnderflow.Migrations
{
    ...
    [Migration("20260823191047_AddThreadReportResolution")]
    partial class AddThreadReportResolution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StackUnderflow.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StackUnderflow.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StackUnderflow.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StackUnderflow.Models.Comment", b =>
                {
                    b.HasOne("StackUnderflow.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("StackUnderflow.Models.ThreadTag", b =>
                {
                    ...
                    b.HasOne("StackUnderflow.Models.Tag", "Tag")
                        .WithMany("ThreadTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
